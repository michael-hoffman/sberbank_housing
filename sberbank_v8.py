...
# Team: Data Science on the Hill
# Author: Charlie Bonfield and Michael Hoffman
# Next goal: incorporate cv into search
# Created: May 2017
...
hyperparameter_tuning.to_csv('hp_tuning_v2.csv')
